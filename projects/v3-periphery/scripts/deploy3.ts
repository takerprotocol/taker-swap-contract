...
const artifacts: { [name: string]: ContractJson } = {
  ...
  TakerInterfaceMulticallV2: require('../artifacts/contracts/lens/TakerInterfaceMulticallV2.sol/TakerInterfaceMulticallV2.json'),
...
async function main() {
  ...
  // const takerV3PoolDeployer_address = deployedContracts.TakerV3PoolDeployer
  // const takerV3Factory_address = deployedContracts.TakerV3Factory
  ...
  // const swapRouter = await SwapRouter.deploy(takerV3PoolDeployer_address, takerV3Factory_address, config.WNATIVE)

  // await tryVerify(swapRouter, [takerV3PoolDeployer_address, takerV3Factory_address, config.WNATIVE])
  ...
  // const TakerInterfaceMulticall = new ContractFactory(
  //   artifacts.TakerInterfaceMulticall.abi,
  //   artifacts.TakerInterfaceMulticall.bytecode,
  //   owner
  // )

  // const takerInterfaceMulticall = await TakerInterfaceMulticall.deploy()
  // console.log('TakerInterfaceMulticall', takerInterfaceMulticall.address)

  // await tryVerify(takerInterfaceMulticall)
  ...
  // const quoterV2 = await QuoterV2.deploy(takerV3PoolDeployer_address, takerV3Factory_address, config.WNATIVE)
  // console.log('QuoterV2', quoterV2.address)

  // await tryVerify(quoterV2, [takerV3PoolDeployer_address, takerV3Factory_address, config.WNATIVE])

  
  const TakerInterfaceMulticallV2 = new ContractFactory(
    artifacts.TakerInterfaceMulticallV2.abi,
    artifacts.TakerInterfaceMulticallV2.bytecode,
    owner
  )
  const takerInterfaceMulticallV2 = await TakerInterfaceMulticallV2.deploy()
  console.log('TakerInterfaceMulticallV2', takerInterfaceMulticallV2.address)
  ...
  const contracts = {
    ...
    // TakerInterfaceMulticall: takerInterfaceMulticall.address,
    TakerInterfaceMulticallV2: takerInterfaceMulticallV2.address,
