...
contract QuoterV2 is IQuoterV2, ITakerV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (ITakerV3Pool) {
        return ITakerV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc ITakerV3SwapCallback
    function takerV3SwapCallback(
        ...
        ITakerV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ITakerV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
