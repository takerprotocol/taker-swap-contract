...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, ITakerV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    function takerV3SwapCallback(
        ...
        ITakerV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ITakerV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
