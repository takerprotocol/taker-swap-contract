...
library SmartRouterHelper {
    ...
    bytes32 internal constant V2_INIT_CODE_HASH = 0x7566e53505922433eae48bd679cbfc938a56abe94852914510cd04d2e758e56d;
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0x18827b24da592813f05c08aa604d4c25741500b9db8c1d4f26cfe2796db1c6eb;
    ...
    /// @param deployer The TakerSwap V3 deployer contract address
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (ITakerV3Pool) {
        return ITakerV3Pool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid TakerSwap V3 Pool
    /// @param deployer The contract address of the TakerSwap V3 deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (ITakerV3Pool pool) {
    ...
    function verifyCallback(address deployer, PoolKey memory poolKey)
        public
        view
        returns (ITakerV3Pool pool)
    {
        pool = ITakerV3Pool(computeAddress(deployer, poolKey));
