...
const TakerStableSwapFactory = artifacts.require("stable-swap/contracts/TakerStableSwapFactory.sol");
const TakerStableSwapLPFactory = artifacts.require("stable-swap/contracts/TakerStableSwapLPFactory.sol");
const TakerStableSwapTwoPoolDeployer = artifacts.require("stable-swap/contracts/TakerStableSwapTwoPoolDeployer.sol");
const TakerStableSwapThreePoolDeployer = artifacts.require("stable-swap/contracts/TakerStableSwapThreePoolDeployer.sol");
const TakerStableSwapTwoPool = artifacts.require("stable-swap/contracts/TakerStableSwapTwoPool.sol");
const TakerStableSwapThreePool = artifacts.require("stable-swap/contracts/TakerStableSwapThreePool.sol");
const TakerStableSwapTwoPoolInfo = artifacts.require("stable-swap/contracts/utils/TakerStableSwapTwoPoolInfo.sol");
const TakerStableSwapThreePoolInfo = artifacts.require("stable-swap/contracts/utils/TakerStableSwapThreePoolInfo.sol");
const TakerStableSwapInfo = artifacts.require("stable-swap/contracts/utils/TakerStableSwapInfo.sol");
const LPToken = artifacts.require("stable-swap/contracts/TakerStableSwapLP.sol");
...
const TakerFactory = artifacts.require("exchange-protocol/contracts/TakerFactory.sol");
const TakerPair = artifacts.require("exchange-protocol/contracts/TakerPair.sol");
const TakerRouter = artifacts.require("exchange-protocol/contracts/TakerRouter.sol");
...
contract("SmartRouter", ([admin, bob, carol]) => {
    ...
    before(async () => {
        ...
        /** Create Stable Swap */
        stableSwapLPFactory = await TakerStableSwapLPFactory.new({ from: admin });
        stableSwap2PoolDeployer = await TakerStableSwapTwoPoolDeployer.new({ from: admin });
        stableSwap3PoolDeployer = await TakerStableSwapThreePoolDeployer.new({ from: admin });
        stableSwapFactory = await TakerStableSwapFactory.new(stableSwapLPFactory.address, stableSwap2PoolDeployer.address, stableSwap3PoolDeployer.address, {
            from: admin,
        });
        stableSwap2PoolInfo = await TakerStableSwapTwoPoolInfo.new({ from: admin });
        stableSwap3PoolInfo = await TakerStableSwapThreePoolInfo.new({ from: admin });
        stableSwapPoolInfo = await TakerStableSwapInfo.new(stableSwap2PoolInfo.address, stableSwap3PoolInfo.address, { from: admin });
        ...
        stable2Pool_BUSD_USDC = await TakerStableSwapTwoPool.at(stable2PoolInfo.swapContract);
        ...
        stable2Pool_WBNB_BUSD = await TakerStableSwapTwoPool.at(stable2PoolInfo_WBNB_BUSD.swapContract);
        ...
        stable3Pool_BUSD_USDC_USDT = await TakerStableSwapThreePool.at(stable3PoolInfo.swapContract);
