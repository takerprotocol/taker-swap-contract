...
const DEFAULT_COMPILER_SETTINGS2 = {
  version: '0.6.6',
  settings: {
    evmVersion: 'istanbul',
    optimizer: {
...
export default {
  ...
  solidity: {
    compilers: [DEFAULT_COMPILER_SETTINGS, DEFAULT_COMPILER_SETTINGS2],
    overrides: {
      'contracts/TakerV3Pool.sol': LOWEST_OPTIMIZER_COMPILER_SETTINGS,
      'contracts/TakerV3PoolDeployer.sol': LOWEST_OPTIMIZER_COMPILER_SETTINGS,
