...
contract TakerV3PoolDeployer is ITakerV3PoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @inheritdoc ITakerV3PoolDeployer
    ...
    /// @param factory The contract address of the TakerSwap V3 factory
    ...
    function deploy(
        ...
        pool = address(new TakerV3Pool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
