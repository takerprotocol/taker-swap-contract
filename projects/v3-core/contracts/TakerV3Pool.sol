...
import './interfaces/ITakerV3PoolDeployer.sol';
...
import './interfaces/ITakerV3LmPool.sol';

contract TakerV3Pool is ITakerV3Pool {
    ...
    /// @inheritdoc ITakerV3PoolImmutables
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == ITakerV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = ITakerV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc ITakerV3PoolDerivedState
    ...
    /// @inheritdoc ITakerV3PoolActions
    ...
    function mint(
        ...
        ITakerV3MintCallback(msg.sender).takerV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            ITakerV3SwapCallback(msg.sender).takerV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        ITakerV3FlashCallback(msg.sender).takerV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc ITakerV3PoolOwnerActions
