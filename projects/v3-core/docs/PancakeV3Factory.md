...
Deploys TakerSwap V3 pools and manages ownership and control over pool protocol fees
...
```solidity
mapping(uint24 => struct ITakerV3Factory.TickSpacingExtraInfo) feeAmountTickSpacingExtraInfo
```
