...
describe('TakerV3Pool', () => {
  ...
  let pool0: MockTimeTakerV3Pool
  let pool1: MockTimeTakerV3Pool
  ...
  let swapTargetCallee: TestTakerV3Callee
  let swapTargetRouter: TestTakerV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeTakerV3Pool, any]> => {
