...
contract RouterImmutables {
    ...
    /// @dev The address of TakerSwapV2Factory
    address internal immutable TAKERSWAP_V2_FACTORY;

    /// @dev The TakerSwapV2Pair initcodehash
    bytes32 internal immutable TAKERSWAP_V2_PAIR_INIT_CODE_HASH;

    /// @dev The address of TakerSwapV3Factory
    address internal immutable TAKERSWAP_V3_FACTORY;

    /// @dev The TakerSwapV3Pool initcodehash
    bytes32 internal immutable TAKERSWAP_V3_POOL_INIT_CODE_HASH;

    /// @dev The address of TakerSwap V3 Deployer
    address internal immutable TAKERSWAP_V3_DEPLOYER;

    /// @dev The address of TakerSwap NFT Market
    address internal immutable TAKERSWAP_NFT_MARKET;
    ...
    constructor(RouterParameters memory params) {
        ...
        TAKERSWAP_V2_FACTORY = params.v2Factory;
        TAKERSWAP_V2_PAIR_INIT_CODE_HASH = params.v2InitCodeHash;
        TAKERSWAP_V3_FACTORY = params.v3Factory;
        TAKERSWAP_V3_POOL_INIT_CODE_HASH = params.v3InitCodeHash;
        TAKERSWAP_V3_DEPLOYER = params.v3Deployer;
        TAKERSWAP_NFT_MARKET = params.takerNFTMarket;
    }
}