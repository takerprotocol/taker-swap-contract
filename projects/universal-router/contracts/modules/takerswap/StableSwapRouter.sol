...
/// @title Router for TakerSwap Stable Trades
abstract contract StableSwapRouter is RouterImmutables, Permit2Payments, Ownable {
    ...
    /**
     * @notice Set Taker Stable Swap Factory and Info
    ...
    /// @notice Performs a TakerSwap stable exact input swap
    ...
    /// @notice Performs a TakerSwap stable exact output swap
    /// @param recipient The recipient of the output tokens
