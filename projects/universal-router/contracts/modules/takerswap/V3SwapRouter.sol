...
import {ITakerV3Pool} from '../../interfaces/ITakerV3Pool.sol';
import {ITakerV3SwapCallback} from '../../interfaces/callback/ITakerV3SwapCallback.sol';
...
/// @title Router for TakerSwap v3 Trades
abstract contract V3SwapRouter is RouterImmutables, Permit2Payments, ITakerV3SwapCallback {
    ...
    function takerV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata data) external {
        ...
        if (UniversalRouterHelper.computePoolAddress(TAKERSWAP_V3_DEPLOYER, TAKERSWAP_V3_POOL_INIT_CODE_HASH, tokenIn, tokenOut, fee) != msg.sender) revert V3InvalidCaller();
    ...
    /// @notice Performs a TakerSwap v3 exact input swap
    ...
    /// @notice Performs a TakerSwap v3 exact output swap
    /// @param recipient The recipient of the output tokens
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = ITakerV3Pool(UniversalRouterHelper.computePoolAddress(TAKERSWAP_V3_DEPLOYER, TAKERSWAP_V3_POOL_INIT_CODE_HASH, tokenIn, tokenOut, fee)).swap(
            recipient,
            zeroForOne,
            amount,
