...
import './interfaces/ITakerV3LmPoolDeveloper.sol';

contract TakerV3LmPool is ITakerV3LmPool {
  ...
  ITakerV3Pool public immutable pool;
  ...
  constructor() {
    (address poolAddress, address masterChefAddress) = ITakerV3LmPoolDeveloper(msg.sender).parameters();
    pool = ITakerV3Pool(poolAddress);
