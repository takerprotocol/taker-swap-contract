...
```solidity
contract ITakerV3FactoryOwner factoryOwner
```
...
```solidity
constructor(address _masterChef, contract ITakerV3FactoryOwner _factoryOwner) public
```

### deploy

```solidity
function deploy(contract ITakerV3Pool pool) external returns (contract ITakerV3LmPool lmPool)
```
...
| ---- | ---- | ----------- |
| pool | contract ITakerV3Pool | The contract address of the TakerSwap V3 pool |
